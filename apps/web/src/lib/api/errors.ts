...
export const ACTION_CODE_PROBLEM: Record<ActionCode, ApiProblemKind> = {
  ...
  gate_b_not_cleared: 'bad-request',
  rom_not_acknowledged: 'bad-request',
  as_built_not_reconciled: 'bad-request',
  ...
  shop_drawings_missing: 'bad-request',
  boq_missing: 'bad-request',
  balance_not_cleared: 'bad-request',
  handoff_not_acknowledged: 'bad-request',
